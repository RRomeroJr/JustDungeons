...
public abstract class BuffEffect : ScriptableObject
{
    ...
    /// </summary>
    public virtual void ApplyEffect(IBuff target, float effectValue)
    {
    }
    ...
    /// </summary>
    public virtual void EndEffect(IBuff target, float effectValue)
    {
    }
    ...
    /// </summary>
    public virtual void StartEffect(IBuff target, float effectValue)
    {
    }
}
