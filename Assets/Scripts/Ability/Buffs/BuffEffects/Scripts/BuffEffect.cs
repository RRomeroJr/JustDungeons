...
public abstract class BuffEffect : ScriptableObject
{
    ...
    /// </summary>
    public virtual void ApplyEffect(GameObject target, float effectValue)
    {
    }
    ...
    /// </summary>
    public virtual void EndEffect(GameObject target, float effectValue)
    {
    }
    ...
    /// </summary>
    public virtual void StartEffect(GameObject target, float effectValue)
    {
    }
}
