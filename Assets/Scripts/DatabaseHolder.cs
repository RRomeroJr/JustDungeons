...
{
    /*
        RR: I could not find a way to insure that PlayerAbilityData and AbilityEffectData scriptable objects remain loaded
    ...
    */
    public PlayerAbilityData padSingleton;
